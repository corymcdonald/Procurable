...
public class MyRequestRecyclerAdapter extends RecyclerView.Adapter<MyRequestRecyclerAdapter.MyViewHolder> {
	public List<RequestRow> mData;
	private LayoutInflater inflater;
	private Context context;

	public MyRequestRecyclerAdapter(Context context, List<RequestRow> data) {
