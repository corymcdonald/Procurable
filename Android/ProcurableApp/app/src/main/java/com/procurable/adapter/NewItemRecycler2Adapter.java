 ...
 */
public class NewItemRecycler2Adapter extends RecyclerView.Adapter<NewItemRecycler2Adapter.MyViewHolder> {
    public List<NewItemRow> mData;
    private LayoutInflater inflater;
    private Context context;

    public NewItemRecycler2Adapter(Context context, List<NewItemRow> data) {
                ...
                public void onClick(View v) {
                    ...
                    popup.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
                        public boolean onMenuItemClick(MenuItem item) {
                            ...
                            Constants.cartAddedItems.get(position).setCount(Integer.parseInt(current.getQuantity()));
                            return true;
                        }
                    });
